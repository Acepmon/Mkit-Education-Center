...
public class Exam {
    ...
    public Exam() {
        ...
        myComboBox1.getItems().addAll("C#Lesson1", "C#Lesson2", "C#Lesson3");
        myComboBox1.setStyle("-fx-font: 22 Roboto;-fx-font: 22 roboto; -fx-text-fill : black-");
        myComboBox1.setValue("C#Lesson1");
        ...
        Scene scene = new Scene(grid, student.config.Config.STAGE_WIDTH, student.config.Config.STAGE_HEIGHT);
