...
public MainFrame() {
    //    myStage.setTitle("Logged in as Student");
        ...
        myScene = new Scene(rootNode, student.config.Config.STAGE_WIDTH, student.config.Config.STAGE_HEIGHT);      //this is a frame size
    ...
    //    myStage.setResizable(false); // Disabling resize for frame
        ...
        //  
        Image logo = new Image("student/resources/logo.png");                          //inserting png logo
 ...
 Logo.setOnMouseMoved(ae -> {                                  //Setting glow effect on mouseover
        ...
        exitlbl.setOnMousePressed(ae -> {
            StudentUITest.setScene(new CustomerLogin(StudentUITest.getStage()).getScene());
        });
