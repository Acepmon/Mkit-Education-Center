...
public class Permission_UI extends Application {
    ...
    public void start(Stage myStage) {
        ...
        for (int i = 0; i < 1; i++) {
			...
			row.add(new Per("Дүн харах", false, false, false, false));
			row.add(new Per("Дүн оруулах", false, false, false, false));
			row.add(new Per("Ирц засах", false, false, false, false));
			row.add(new Per("Мэдээлэл харах", false, false, false, false));
        }
