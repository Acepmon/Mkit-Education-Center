...
public class DaalgavarSend1 {
    ...
    public DaalgavarSend1() {
        ...
        daalgavaryaw.setFont(new Font("Arial", 25));
        daalgavaryaw.setStyle("-fx-background-color: #A3A9AD; -fx-padding: 5px 20px 14px 0px;");
...
//        pnl.add(svvliinfld, 0, 7);
        pnl.add(onsar1, 0, 7);
        pnl.add(pictureRegion, 1, 1);
        pnl.add(pictureRegion1, 1, 3);
        pnl.add(pictureRegion2, 1, 5);
        pnl.add(pictureRegion3, 1, 7);
