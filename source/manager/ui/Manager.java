...
public class Manager {
    ...
    public Manager() {
        ...
        tabProgram.setOnSelectionChanged(ae-> {
            ...
            tabProgram.setContent(program.getProgramPane());
        });
        ...
        tabTeacher.setOnSelectionChanged(ae-> {
            ...
            tabTeacher.setContent(teacher.getTeacherPane());
        });
        ...
        tabStudent.setOnSelectionChanged(ae-> {
            ...
            tabStudent.setContent(student.getStudentPane());
        });
        ...
        tabReport.setOnSelectionChanged(ae-> {
            ...
            tabReport.setContent(report.getReportPane());
        });
