...
public class Student {
    ...
    private ObservableList<StudentObj> data=FXCollections.observableArrayList();
    ...
    public void StudentData() {
        ...
        computerCol.setCellValueFactory(new PropertyValueFactory<>("computerName"));
