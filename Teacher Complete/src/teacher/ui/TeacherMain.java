...
//2//
        ...
        dropdown2.setLayoutX(teacher.config.Config.STAGE_WIDTH - 903);
...
//        t.setPadding(new Insets(0, 0, 0, 364));
        t.setPadding(new Insets(0, 0, 0, 120));

        Label duntoo = new Label(" Дүн тооцоолол");

        duntoo.setPrefSize(150, 35);
//          homework.setAlignment(Pos.CENTER_LEFT);
        duntoo.setFont(Font.font("Arial", 12));
        duntoo.setId("downmenu");
        duntoo.setOnMousePressed((MouseEvent event) -> {
...
//      profile.setAlignment(Pos.BOTTOM_LEFT);
        ...
        profile.setOnMousePressed(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                TeacherMain.changeCenter(Launcher.getTEACHER_PROFILE().getContainer());
        ...
        homework = new Label(" Даалгавар Илгээх");
...
//          log.setStyle("-fx-Background-color:#808080");
        ...
        dropdown.getChildren().addAll(duntoo, homework, profile, other, log);
...
//        other.setAlignment(Pos.CENTER_LEFT);
        irtsBurtgel.setOnMousePressed(new EventHandler<MouseEvent>() {
            ...
            @Override
            public void handle(MouseEvent event) {
                rootNode.setCenter(new IrtsBurtgel().getContainer());
...
//          log.setStyle("-fx-Background-color:#808080");
        ...
        niitIrts.setOnMousePressed(new EventHandler<MouseEvent>() {
            ...
            @Override
            public void handle(MouseEvent event) {
                rootNode.setCenter(new Idevhi().getContainer());
                if (dropdown2.isVisible()) {
                    TeacherMain.changeLeft(null);
                    dropdown2.setVisible(false);
                }
        ...
        Label shalgaltdun = new Label("Шалгалт дүн");
//        idevhiinDunOruulah = new Label(" Идэвхийн дүн оруулах");
//
//        idevhiinDunOruulah.setPrefSize(150, 35);
//        homework.setAlignment(Pos.CENTER_LEFT);
...
//          log.setAlignment(Pos.CENTER_LEFT);
        shalgaltdun.setFont(Font.font("Arial", 12));
        shalgaltdun.setPrefSize(150, 35);
//          log.setStyle("-fx-Background-color:#808080");
        shalgaltdun.setId("downmenu");
        shalgaltdun.setOnMousePressed(new EventHandler<MouseEvent>() {

            @Override
            public void handle(MouseEvent event) {
                rootNode.setCenter(Launcher.getSHALGALT_DUN().getContainer());
                if (dropdown2.isVisible()) {
                    TeacherMain.changeLeft(null);
                    dropdown2.setVisible(false);
                }
        ...
        Label DaalgavarShalgahDun = new Label("Даалгавар дүн");

        DaalgavarShalgahDun.setFont(Font.font("Arial", 12));
        DaalgavarShalgahDun.setPrefSize(150, 35);
        DaalgavarShalgahDun.setId("downmenu");
        DaalgavarShalgahDun.setOnMousePressed(new EventHandler<MouseEvent>() {

            @Override
            public void handle(MouseEvent event) {
                rootNode.setCenter(Launcher.getDAALGAVARSHALGAHDUN().getContainer());
                if (dropdown2.isVisible()) {
                    TeacherMain.changeLeft(null);
                    dropdown2.setVisible(false);
                }
        ...
        dropdown2.getChildren().addAll(irtsBurtgel, niitIrts, shalgaltdun,DaalgavarShalgahDun);
...
//            TeacherMain.changeLeft(new Huvaari().getContainer());
//            TeacherMain.changeCenter(new Medeelel().getContainer());
//            TeacherMain.changeRight(null);
//            rootNode.setCenter(Launcher.getDUNORUULAH().getContainer());
            TeacherMain.changeCenter(Launcher.getDUNORUULAH().getContainer());
            TeacherMain.changeLeft(null);
            TeacherMain.changeRight(null);
        });
...
//            TeacherMain.changeLeft(null);
            ...
            TeacherMain.changeRight(new HomeworkLastResived().getContainer());
        });
...
//        scoreBtn.setPrefSize(120, 60);
        ...
        topFp.getChildren().addAll(mainBtn, scoreBtn, tailanBtn, hooson, t);
