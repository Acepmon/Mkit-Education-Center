...
//        comboClass.setId("content_label");
        ...
        Image image = new Image("teacher/resource/images.jpg");
        
        Image imageChooser = new Image("teacher/resource/nobody.png");
        imageView.setImage(imageChooser);           
...
//        String profile = (String) ServerConnection.RequestAjluulah("teacherLogin", "bolooAcc");
...
//            if (arr[arr.length-1] == null || arr[arr.length-1].equals("") || arr[arr.length-1].equals("null")) {
//                imageView.setImage(imageChooser);
//            } else {
